...
contract ConfigurableRightsPool is PCToken, BalancerOwnable, BalancerReentrancyGuard {
    ...
    function applyAddToken() external virtual logs lock onlyOwner needsBPool {
        ...
        // Delegate to library to save space
        SmartPoolManager.applyAddToken(this, bPool, addTokenTimeLockInBlocks, newToken);
    }
        ...
        lockUnderlyingPool
    {
        ...
        uint256[] memory actualAmountsIn = SmartPoolManager.joinPool(this, bPool, poolAmountOut, maxAmountsIn);
    ...
    function joinswapExternAmountIn(
        ...
        // Delegate to library to save space
        poolAmountOut = SmartPoolManager.joinswapExternAmountIn(this, bPool, tokenIn, tokenAmountIn, minPoolAmountOut);
    ...
    function joinswapPoolAmountOut(
        ...
        // Delegate to library to save space
        tokenAmountIn = SmartPoolManager.joinswapPoolAmountOut(this, bPool, tokenIn, poolAmountOut, maxAmountIn);
