...
library SmartPoolManager {
     ...
     */
    function pokeWeights(IBPool bPool, ConfigurableRightsPool.GradualUpdateParams storage gradualUpdate) external {
    ...
    function updateWeightsGradually(
        ...
        require(
            BalancerSafeMath.bsub(endBlock, startBlock) >= minimumWeightChangeBlockPeriod,
