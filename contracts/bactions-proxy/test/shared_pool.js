...
contract('BActions', async (accounts) => {
    ...
    describe('Shared pool', () => {
        ...
        before(async () => {
            ...
            const params = [FACTORY, tokens, balances, weights, swapFee, protocolFee, finalize];
        ...
        it('allows join from creator', async () => {
            ...
            const params = [POOL, toWei('20'), [toWei('80'), toWei('0.2'), toWei('0.8')]];
        ...
        it('allows join from user', async () => {
            ...
            const joinInterface = BActions.abi.find((iface) => iface.name === 'joinPool');
            const params = [POOL, toWei('40'), [toWei('200'), toWei('0.5'), toWei('2')]];
