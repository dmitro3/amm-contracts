...
//             CRPPOOL = await crpFactory.newEsp.call(bFactory.address, poolParams, permissions);

//             await crpFactory.newEsp(bFactory.address, poolParams, permissions);
...
//             await truffleAssert.reverts(crpPool.updateWeight(DAI, toWei('3')), 'ERR_UNSUPPORTED_OPERATION');
//         });
...
//             await truffleAssert.reverts(crpPool.pokeWeights(), 'ERR_UNSUPPORTED_OPERATION');
//         });

//         it('Should not allow calling overloaded createPool', async () => {
//             await truffleAssert.reverts(crpPool.createPool(toWei('100'), 10, 10), 'ERR_UNSUPPORTED_OPERATION');
//         });
//     });
// });
